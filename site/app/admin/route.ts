    ...
    function renderTable(type, rows) {
      ...
      if (type === 'cast') {
        ...
        bodyRows = rows.map(r => \`<tr class="border-t border-gray-100 hover:bg-gray-50">
          ...
          <td class="px-4 py-3 text-sm text-gray-600 max-w-[120px] truncate">\${r.maker || '—'}</td>
